    ...
    return (
        <>
            ...
            >
                ...
                <Stack>
                    <Stack mb={2}>
                        <StyledSubtitle>Daily</StyledSubtitle>
                    ...
                    <Stack mb={2}>
                        <StyledSubtitle>Monthly</StyledSubtitle>
                        <Stack direction="row" justifyContent="space-between">
                            <CustomizedBox
                                // @ts-ignore
                    ...
                    <Stack mb={2}>
                        <StyledSubtitle>Annualy</StyledSubtitle>
                        <Stack direction="row" justifyContent="space-between">
                            <CustomizedBox
                                // @ts-ignore
